...
// chosen for short, distinct, easy-to-type words. Six words drawn uniformly
// give ~62 bits of entropy before scrypt stretching.
var tempWords = []string{
	...
	"yard", "year", "yeast", "yelp", "yield", "yo-yo", "yodel", "yoga",
