...
func TestSplitOnboardingString(t *testing.T) {
	pass, fp := splitOnboardingString("edge-bats-prize-dab-pagan-probe-acid-acorn/3f6k2c7m4x2pqr5s")
	if pass != "edge-bats-prize-dab-pagan-probe-acid-acorn" || fp != "3f6k2c7m4x2pqr5s" {
		t.Fatalf("split = %q, %q", pass, fp)
	}
	for _, plain := range []string{
		"my own passphrase",
		"with/slash",
		"edge-bats-prize-dab-pagan-probe-acid-acorn",                  // no code
		"edge-bats-prize-dab-pagan-probe-acid-acorn/3f6k2c",           // code too short
		"edge-bats-prize-dab-pagan-probe-acid/3f6k2c7m4x2pqr5s",       // too few words (7)
		"Edge-bats-prize-dab-pagan-probe-acid-acorn/3f6k2c7m4x2pqr5s", // uppercase
		"edge-bats-prize-dab-pagan-probe-acid-acorn/3f6k2c7m4x2pqr51", // 1 is not base32
	} {
